...
class AddLocationPicker extends StatefulWidget {
  const AddLocationPicker({super.key});

  @override
  _AddLocationPickerState createState() => _AddLocationPickerState();
}

class _AddLocationPickerState extends State<AddLocationPicker> {
  ...
  _AddLocationPickerState() : _service = LocationService(LocationRepository());
